...
const config = {
  headers: {
    ...
    if (user) {
      axios.get(`http://localhost:8000/getbookings/${user.id}`, config)
        .then((response) => {
        ...
        // Grooming
        axios.get(`http://localhost:8000/getbookgroom/${user.id}`, config)
        .then((response) => {
          const taskData = response.data;
          setGroom(taskData);
          console.log(taskData)
        ...
        //   Wellness
        axios.get(`http://localhost:8000/getbookwellness/${user.id}`, config)
        .then((response) => {
          const taskData = response.data;
        ...
        // Additional
        axios.get(`http://localhost:8000/getbookadditional/${user.id}`, config)
        .then((response) => {
          const taskData = response.data;
